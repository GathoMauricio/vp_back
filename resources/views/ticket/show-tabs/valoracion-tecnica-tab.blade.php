    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea name="danio" id="danio" class="form-control" readonly>{{ old('danio', $ticket->danio ?: '') }}</textarea>
                @error('danio')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea name="advertencia" id="advertencia" class="form-control" readonly>{{ old('advertencia', $ticket->advertencia ?: '') }}</textarea>
                @error('advertencia')
                    <small style="color:red;">
                        <strong>{{ $message }}</strong>
                    </small>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea name="solucion" id="solucion" class="form-control" readonly>{{ old('solucion', $ticket->solucion ?: '') }}</textarea>
                @error('solucion')
                    <small style="color:red;">
                        <strong>{{ $message }}</strong>
                    </small>
