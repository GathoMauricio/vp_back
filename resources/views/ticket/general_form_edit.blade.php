                ...
                <select onchange="loadUsersByClient(this.value)" name="client_id" id="client_id"
                    ...
                    @foreach ($clients as $client)
                        @if ($ticket->usuario->cliente->id == $client->id)
                            <option value="{{ $client->id }}" selected>{{ $client->razon_social }}
                            </option>
                        @else
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input value="{{ old('disco_duro_equipo', $ticket->disco_duro_equipo ?: '') }}" type="text"
                    name="disco_duro_equipo" id="disco_duro_equipo" class="form-control">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input value="{{ old('procesador_equipo', $ticket->procesador_equipo ?: '') }}" type="text"
                    name="procesador_equipo" id="procesador_equipo" class="form-control">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input value="{{ old('ram_equipo', $ticket->ram_equipo ?: '') }}" type="text" name="ram_equipo"
                    id="ram_equipo" class="form-control">
                @error('ram_equipo')
                    <small style="color:red;">
                        <strong>{{ $message }}</strong>
                    </small>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input value="{{ old('so_equipo', $ticket->so_equipo ?: '') }}" type="text" name="so_equipo"
                    id="so_equipo" class="form-control">
                @error('so_equipo')
                    <small style="color:red;">
                        <strong>{{ $message }}</strong>
                    </small>
