    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input value="{{ old('office_equipo') }}" type="text" name="office_equipo" id="office_equipo"
                    class="form-control">
                @error('office_equipo')
                    <small style="color:red;">
                        <strong>{{ $message }}</strong>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label for="office_caducidad_equipo" class="vp-label-form">CADUCIDAD | DÍAS
                    RESTANTES</label>
                <input value="{{ old('office_caducidad_equipo') }}" type="number" name="office_caducidad_equipo"
                    id="office_caducidad_equipo" class="form-control">
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label for="antivirus_caducidad_equipo" class="vp-label-form">CADUCIDAD | DÍAS
                    RESTANTES</label>
                <input value="{{ old('antivirus_caducidad_equipo') }}" type="number" name="antivirus_caducidad_equipo"
                    id="antivirus_caducidad_equipo" class="form-control">
