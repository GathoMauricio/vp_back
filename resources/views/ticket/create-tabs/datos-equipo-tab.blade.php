    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input value="{{ old('marca_equipo') }}" type="text" name="marca_equipo" id="marca_equipo"
                    class="form-control">
                @error('marca_equipo')
                    <small style="color:red;">
                        <strong>{{ $message }}</strong>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input value="{{ old('modelo_equipo') }}" type="text" name="modelo_equipo" id="modelo_equipo"
                    class="form-control">
                @error('modelo_equipo')
                    <small style="color:red;">
                        <strong>{{ $message }}</strong>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input value="{{ old('serie_equipo') }}" type="text" name="serie_equipo" id="serie_equipo"
                    class="form-control">
                @error('serie_equipo')
                    <small style="color:red;">
                        <strong>{{ $message }}</strong>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input value="{{ old('password_equipo') }}" type="text" name="password_equipo" id="password_equipo"
                    class="form-control">
