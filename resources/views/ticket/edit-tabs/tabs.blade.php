<ul class="nav nav-tabs" id="myTab" role="tablist">
    ...
    <li class="nav-item" role="presentation">
        <button class="nav-link" id="tipo-mantenimiento-tab" data-bs-toggle="tab" data-bs-target="#tipo-mantenimiento"
            type="button" role="tab" aria-controls="tipo-mantenimiento" aria-selected="false">TIPO DE
    ...
    <li class="nav-item" role="presentation">
        <button class="nav-link" id="valoracion-tecnica-tab" data-bs-toggle="tab" data-bs-target="#valoracion-tecnica"
            type="button" role="tab" aria-controls="valoracion-tecnica" aria-selected="false">VALORACIÓN
            TÉCNICA</button>
    </li>
    <li class="nav-item" role="presentation">
