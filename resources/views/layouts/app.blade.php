...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('alertify/alertify.css') }}" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('alertify/semantic.css') }}" rel="stylesheet">
    ...
    <link rel="stylesheet" href="{{ asset('css/font.css') }}" rel="stylesheet">
